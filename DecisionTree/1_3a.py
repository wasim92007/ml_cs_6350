...
if __name__ == '__main__':
    ...
    ## Use the most common value in the training data as the missing value
    ## Get the most common value for the missing feature from the whole dataset
    most_common_value = get_majority_label(train_ds[:,attrib_name_col_dic['Outlook']])
    print(f'Most common value for the outlook in the dataset is {most_common_value}')
