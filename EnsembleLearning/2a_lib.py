...
if __name__ == '__main__':
    ...
    for datapoint in train_ds:
        train_ds_feat.append(datapoint[:-1])
        train_ds_label.append(datapoint[-1])
    from sklearn.ensemble import AdaBoostClassifier
    clf = AdaBoostClassifier(n_estimators=10, random_state=0)
    clf.fit(train_ds_feat, train_ds_label)
    exit()
    ...
    ## Perform unit test
    train_prediction, train_prediction_hist = adaboost_cs.predict_datapoint(datapoint=train_ds[0], pos_label='yes', neg_label='no')
