...
class Bagging(object):
    ...
    def perform_bagging(self, train_ds, test_ds, t_init=0, *args, **kwargs):
        '''
        Perform Bagging for t iterations
        '''
        ...
        for t in range(t_init, self.num_rounds):
            print(f'{line}Performing bagging iteration {t+1}/{self.num_rounds}')
            ...
            if self.classifier_type == 'decision_tree':
                ...
                classifier_cs.build_tree(dataset=sampled_train_ds[:], attrib_name_col_dic=kwargs['attrib_name_col_dic'], attrib_name_vals_dic=kwargs['attrib_name_vals_dic'])
